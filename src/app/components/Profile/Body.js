...
const Body = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      <Item icon="location" title={user.address ? user.address.substr(0, 50).concat('...') : formattedAddress ? formattedAddress.substr(0, 50).concat('...') : 'Address'} onPress={() => navigation.navigate('Address')} />
